      ...
      <Block>
        ...
        >
          <Flex flexDirection="column" gutter={24}>
            ...
            <H1>API</H1>
            <P>
              All of the components allow you to pass in arbitrary CSS
              properties as props. This is meant to make our lives easier when
              elements require minor adjustments. For more complex styles you
              should create new components with glamorous or (preferably) wrap
              existing components from this library with new styles.
            </P>
            <P>
              Some of the components can have different sets of colors, these
              are usually configured by providing a prop that determines their
              type. For now, you can examine how the demos are rendered below by
              installing the React Dev Tools.
            </P>
            <P>
              This project is still a work in progress, so please report any
              bugs or inconsistencies you may find or thoughts about potential
              improvements.
            </P>
          </Flex>
